...
local osc_styles = {
    ...
    SeekbarFg = '{\\blur1\\bord1\\1c&HFFAF54&}',
...
layouts["reduced"] = function ()
    ...
    lo.geometry = {x = osc_geo.w - 180, y = refY - 40, an = 5, w = 24, h = 24}
    ...
    lo.geometry = {x = osc_geo.w - 150, y = refY - 40, an = 4, w = 80, h = 2}
    lo.layer = 13
    lo.style = osc_styles.VolumebarBg
    
    lo = add_layout('volumebar')
    lo.geometry = {x = osc_geo.w - 150, y = refY - 40, an = 4, w = 80, h = 8}
    ...
    geo = { x = 25, y = 60, an = 1, w = osc_geo.w - 50, h = 48 }
    lo = add_layout('title')
    lo.geometry = geo
